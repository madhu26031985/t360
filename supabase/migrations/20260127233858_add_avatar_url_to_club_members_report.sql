/*
  # Add avatar_url to Club Members Report Function

  1. Changes
    - Add avatar_url field to the get_club_members_report function return type
    - Include avatar_url in the SELECT and GROUP BY clauses
  
  2. Purpose
    - Enable profile picture display in the club members report interface
*/
